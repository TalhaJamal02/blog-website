...
const ExploringMars = () => {
  return (
    <div className="max-w-3xl mx-auto p-6 bg-white rounded-lg shadow-md mt-12">
      <h1 className="text-4xl font-semibold text-gray-800">Exploring Mars: What's Next for Space Exploration?</h1>
