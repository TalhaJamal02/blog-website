  ...
  return (
    <div className="max-w-3xl mx-auto p-6 bg-white rounded-lg shadow-md mt-12">
      ...
      <div className="mt-6 space-y-4">
        ...
        <p>
          Quantum computers also hold the potential to revolutionize drug discovery and healthcare. By simulating molecular structures and chemical reactions with unparalleled precision, quantum systems can accelerate the development of new medicines and treatments. This capability could lead to breakthroughs in curing diseases and designing personalized medicine tailored to an individuals genetic makeup.
        </p>
        <p>
