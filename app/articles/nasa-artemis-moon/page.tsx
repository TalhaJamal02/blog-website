  ...
  return (
    <div className="max-w-3xl mx-auto p-6 bg-white rounded-lg shadow-md mt-12">
      ...
      <div className="mt-6 space-y-4">
        ...
        <p>
          The Artemis program is not just about science and exploration; it about inspiring humanity. By returning to the Moon and looking toward Mars, Artemis embodies the spirit of adventure, innovation, and perseverance. It serves as a reminder of what we can achieve when we aim for the stars.
        </p>
        <p>
